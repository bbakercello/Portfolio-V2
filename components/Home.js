  ...
  return (
    <div id='home'className='lg:scale-125 lg:p-20 grid justify-center sm:flex pt-12 sm:justify-around lg:justify-evenly mt-10 '>
        ...
        <div className='flex mt-2 '>
            ...
            <button className='relative w-20  h-8 bg-sky-700 self-center rounded-lg text-sm text-slate-200'><Link activeClass='active' to='contact' spy={true} smooth={true} offset={50} duration={500}>Contact</Link></button>
            </div>

            <div className='relative'>
            <div className='absolute inset-0 bg-sky-700 blur rounded-lg'></div>
            <button className='relative w-40 h-8 bg-sky-700 ml-2 self-center rounded-lg text-sm text-slate-200'><a target="_blank" href='https://drive.google.com/file/d/14fm8qSMMorGMkS6lBD3ANq6H9osy9BwJ/view?usp=sharing' download='BenBakerSoftwareEngineer.pdf'>Download Resume</a></button>
            </div>
        </div>
        ...
        <div className='relative'>
          ...
          <img src='https://i.imgur.com/fve5JWA.png' alt='Profile Photo' className='relative invisible w-1 sm:visible sm:w-60 row-start-1 row-span-1'></img>
          </div>
        </div>
